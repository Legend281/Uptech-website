...
const serviceCards: Array<{
  ...
  {
    // Unified per leadership decision — this used to be two separate cards
    // ("...Businesses" and "...Individuals"); the individuals-only URL now
    // redirects here, so it no longer needs its own card.
    title: "Tax Compliance — Cameroon",
    description:
      "Monthly DGI declarations, statistical and tax filings (DSF), and Attestation de Non-Redevance clearance for businesses and individuals alike, on a predictable calendar.",
