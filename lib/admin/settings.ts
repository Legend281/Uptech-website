...
import { DEFAULT_DUE_SOON_DAYS } from "./staleness";
import { mockServicePages } from "./mockData";
...
export const DEFAULT_SETTINGS: Settings = {
  ...
  reviewCycles: Object.fromEntries(
    mockServicePages.map((page) => [page.id, { cadenceDays: page.reviewCadenceDays, dueSoonDays: page.dueSoonDays ?? DEFAULT_DUE_SOON_DAYS }]),
  ),
  notifications: {},
  company: {
